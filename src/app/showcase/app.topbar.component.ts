import { Component, EventEmitter, Output, ViewChild, ElementRef, Input, OnInit, OnDestroy, AfterViewInit, AfterViewChecked } from '@angular/core';
    ...
    template: `
        <div class="layout-topbar">
            ...
            <!--span class="p-input-icon-left">
                ...
                <input type="text" *ngIf="navigation != 'search'" (click)="search()" readonly pInputText placeholder="Search" [(ngModel)]="value3" />
                <input type="text" #myinput *ngIf="navigation == 'search'"  pInputText placeholder="Search" [(ngModel)]="value3" />
            </span-->
            <a class="menu-button" (click)="onMenuButtonClick($event)">
                <i class="pi pi-shopping-cart" pBadge style="font-size: 2rem" value="2"></i>
            </a>
            ...
            <ul #topbarMenu class="topbar-menu">
                ...
                <li class="topbar-submenu">
                    <a tabindex="0" (click)="toggleMenu($event, 0)">Themes <i class="pi pi-arrow-down" style="font-size:9px;"></i></a>
                ...
                <li class="topbar-submenu">
                    <a tabindex="0" (click)="toggleMenu($event, 1)">Templates<i class="pi pi-arrow-down" style="font-size:9px;"></i></a>
                ...
                <li class="topbar-submenu">
                    <a tabindex="0" (click)="toggleMenu($event, 2)">Resources<i class="pi pi-arrow-down" style="font-size:9px;"></i></a>
                    <ul [@overlayMenuAnimation]="'visible'" *ngIf="activeMenuIndex === 2" (@overlayMenuAnimation.start)="onOverlayMenuEnter($event)">

                        <li><a href="#" ><span>About PrimeTek</span></a></li>
                        ...
                        <div class="p-grid p-flex-column p-nogutter">
                            <div class="p-col">
                        ...
                        <div class="p-d-flex p-jc-between">
                            <div class="p-mr-5" ><p-button label="Clear" icon="pi pi-arrow-left"></p-button></div>
                            <div class="p-ml-5" ><p-button label="Apply" icon="pi pi-arrow-right" iconPos="right"></p-button></div>
                        </div>
                    </ul>
                </li>
                <li class="topbar-submenu">
                ...
                <button pButton pRipple (click)="show()" type="button" icon="pi pi-cog" class="p-button-rounded p-button-text"></button>
            </ul>
...
export class AppTopBarComponent implements OnInit, AfterViewChecked, OnDestroy {
    ...
    constructor(private router: Router, private versionService: VersionService, private configService: AppConfigService,
        private filterService: FilterService,public dialogService: DialogService, public messageService: MessageService) {}
